...
const projects = [
  ...
  },
  {
    ...
    longDescription:
      "An intelligent chat application that combines real-time messaging with AI-powered responses. Features include group chats, file sharing, and smart conversation analysis.",
